...
def test_linear_search_cases():
    ...
    # Decimal values are used in the weather files.
    assert linear_search_all([12.5, 18.0, 12.5], 12.5) == [0, 2]
...
def test_binary_search_cases():
    ...
    # Binary Search also needs to work with decimal sorted data.
    assert binary_search_all([9.1, 12.5, 12.5, 18.0], 12.5) == [1, 2]
...
def test_nearest_values_cases():
    ...
    # Decimal nearest-value case.
    assert nearest_values([10.5, 12.5, 15.0], 13.0) == [(12.5, [1])]
...
if __name__ == "__main__":
    ...
    print("\nAll searching tests completed successfully")
